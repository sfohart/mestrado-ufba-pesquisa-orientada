package br.ufba.dcc.mestrado.computacao.entities.openhub.core.language;
...
@Entity
@Table(name = OpenHubLanguageEntity.NODE_NAME)
public class OpenHubLanguageEntity implements BaseEntity<Long> {

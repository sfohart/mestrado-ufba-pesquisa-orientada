...
@Entity
@Table(name=OpenHubContributorLanguageFactEntity.NODE_NAME)
public class OpenHubContributorLanguageFactEntity implements BaseEntity<Long> {
	...
	private OpenHubContributorFactEntity contributorFact;
	...
	public OpenHubContributorFactEntity getContributorFact() {
		return contributorFact;
	}
	
	public void setContributorFact(OpenHubContributorFactEntity contributorFact) {

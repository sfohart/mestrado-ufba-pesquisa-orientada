package br.ufba.dcc.mestrado.computacao.entities.openhub.core.kudoskore;
...
@Entity
@Table(name=OpenHubKudoScoreEntity.NODE_NAME)
public class OpenHubKudoScoreEntity implements BaseEntity<Long> {

package br.ufba.dcc.mestrado.computacao.entities.openhub.core.sizefact;
...
@Entity
@Table(name = OpenHubSizeFactEntity.NODE_NAME)
public class OpenHubSizeFactEntity implements BaseEntity<Long> {

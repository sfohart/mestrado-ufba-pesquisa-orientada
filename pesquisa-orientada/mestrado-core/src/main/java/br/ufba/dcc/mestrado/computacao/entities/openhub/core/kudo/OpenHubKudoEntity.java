package br.ufba.dcc.mestrado.computacao.entities.openhub.core.kudo;
...
@Entity
@Table(name = OpenHubKudoEntity.NODE_NAME)
public class OpenHubKudoEntity implements BaseEntity<Long> {
